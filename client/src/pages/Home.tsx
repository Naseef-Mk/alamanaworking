        ...
        <div className="layout shell-row">
          ...
          >
            ...
            >
              <path
                fill="currentColor"
                d="M19.05 4.94A9.9 9.9 0 0 0 12 2C6.48 2 2 6.48 2 12c0 1.75.46 3.46 1.32 4.97L2 22l5.18-1.29A9.96 9.96 0 0 0 12 22c5.52 0 10-4.48 10-10 0-2.67-1.04-5.18-2.95-7.06Zm-7.05 15.37a8.3 8.3 0 0 1-4.23-1.16l-.3-.18-3.08.77.82-3-.2-.31A8.28 8.28 0 0 1 3.7 12c0-4.58 3.72-8.3 8.3-8.3 2.22 0 4.3.86 5.87 2.43A8.24 8.24 0 0 1 20.3 12c0 4.58-3.72 8.31-8.3 8.31Zm4.55-6.2c-.25-.12-1.47-.72-1.7-.8-.23-.08-.4-.12-.57.12-.17.25-.65.8-.8.96-.15.17-.3.19-.55.06-.25-.12-1.07-.39-2.03-1.24-.75-.66-1.26-1.47-1.4-1.72-.15-.25-.02-.38.1-.5.11-.11.25-.3.37-.44.12-.15.17-.25.25-.42.08-.17.04-.31-.02-.44-.06-.12-.57-1.37-.78-1.88-.2-.49-.41-.42-.57-.43h-.48c-.17 0-.44.06-.67.31-.23.25-.88.86-.88 2.09s.9 2.43 1.02 2.59c.12.17 1.78 2.72 4.31 3.81.6.26 1.07.42 1.44.54.61.19 1.17.16 1.61.1.49-.07 1.47-.6 1.67-1.18.21-.58.21-1.08.15-1.18-.06-.1-.23-.16-.48-.29Z"
              />
            </svg>
          </a>
        </div>
